...
import { createProject, updateProject } from "../src/lib/projectsFunctions";
import useProjectForm, { NewProjectData } from "../src/hooks/useProjectForm";

const EditProjectModal: React.FC<{
  isOpen: boolean;
  setIsModalOpen: (isOpen: boolean) => void;
  projectData: NewProjectData;
}> = ({ isOpen, setIsModalOpen, projectData }) => {
  const closeHandler = () => {
