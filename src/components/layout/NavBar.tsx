      ...
      <div className={`sidebar ${isNavMinimized ? "sidebar--minimized" : ""}`}>
        ...
        {status === "loading" && (
          <div className="sidebar__add-container">
            <LoadingSkeleton
              className="sidebar__nav-link-loading sidebar__nav-link-loading--workspace-link"
              isDark={true}
            />
          </div>
        )}
        {status === "success" && <WorkspaceLink />}
        ...
        <div className="sidebar__menu-buttons">
          ...
          {status === "loading" && (
            <div className="sidebar__loading">
              <div className="sidebar__add-container">
                <LoadingSkeleton
                  className="sidebar__nav-link-loading"
                  isDark={true}
                />
              </div>
              <div className="sidebar__add-container">
          ...
          {status === "success" && (
            <WorkspaceList isNavMinimized={isNavMinimized} />
          )}
