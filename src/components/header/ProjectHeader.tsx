    ...
    <>
      <header className="project-header">
        <div className="project-header__top">
          ...
          <DropDown className="project-header__edit-container" theme="light">
            <DropDown.Button className="project-header__edit-btn light">
              <svg
...
const StatusButton = ({
  ...
  return (
    <DropDown theme="light">
      <DropDown.Button className="project-header__status-btn light">
        {" "}
        {status === "Active" && (
          <div className="flex">
            <svg
