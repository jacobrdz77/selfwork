...
const NoTaskLists: React.FC<{ buttonHandler: () => void }> = ({
  buttonHandler,
}) => {
  return (
    <div className="h-full flex mt-[10rem] justify-center text-center">
      <div className="flex flex-col p-3">
        ...
        <div className="flex flex-col">
          <h1 className="text-2xl mt-4">No task lists</h1>
        ...
        <div>
          <button
            className="text-[14px] mt-6 bg-blue-500
           text-white px-3 py-2 rounded-lg hover:bg-blue-600"
