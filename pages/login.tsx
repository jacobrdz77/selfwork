...
const Login: React.FC = () => {
  ...
  return (
    <>
      ...
      "
      >
        <div className="flex flex-col justify-center w-full h-full p-6 max-w-[400px] ">
          ...
          {/* {!session && (
            <div className="flex flex-col gap-3">
              <button
                ...
                className="py-3 bg-github text-white flex justify-center items-center rounded-lg hover:bg-githubHover"
              >
          ...
          {/* {session && (
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="py-3 bg-button text-white flex justify-center items-center rounded-lg hover:bg-buttonHover"
              >
